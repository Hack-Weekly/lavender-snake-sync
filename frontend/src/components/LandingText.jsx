  ...
  return (
    <div className="flex flex-col md:flex-row justify-evenly items-center overflow-hidden">
      <div className="flex flex-col text-center md:text-left">
        ...
        <div className="flex flex-col items-center md:items-start mt-4"> {/* Wrap button and image in a flex container */}
          <Button size="sm" color="dark" pill>Try for free</Button>
        </div>
      </div>
      <div className="w-full md:w-2/4 bg-lime p-10 rounded-3xl">
